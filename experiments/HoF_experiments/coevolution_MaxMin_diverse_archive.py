...
from evolutionary.archive_policy import MaxMinDiverseArchive
...
def co_evolve(resistance_ea, spy_ea, 
    ...
    resistance_archive = MaxMinDiverseArchive(max_size=100)
    spy_archive      = MaxMinDiverseArchive(max_size=100)
    ...
    for generation in range(1, num_gen + 1):
        ...
        for ind in resistance_offspring:
            opponent_pool = spy_archive.get_archive()
            fitness = resistance_ea._evaluate_individual(individual=ind, 
                                                         role='resistance', 
...
if __name__ == "__main__":
    ...
    base_dir = os.path.join("results", "MaxMin_Diverse_Archive")
    ...
    for run_idx in range(1, evolutionary_runs + 1):
        ...
        print("################ Using MaxMinDiverseArchive #################")
