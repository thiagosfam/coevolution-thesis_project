...
from evolutionary.archive_policy import HallOfFameArchive
...
def co_evolve(resistance_ea, spy_ea, 
    ...
    resistance_archive = HallOfFameArchive(max_size=100)
    spy_archive      = HallOfFameArchive(max_size=100)
...
if __name__ == "__main__":
    ...
    base_dir = os.path.join("results", "HoF_archive")
