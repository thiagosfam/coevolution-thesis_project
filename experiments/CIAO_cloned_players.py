    ...
    for run_id in range(1, 11):
        ...
        for gx in range(n_generations):
            ...
            for gy in range(n_generations):
                ...
                spy_wins = 0
                assert len(spy_genes) == 10
                assert len(res_genes) == 14
                players = [spy_genes]*2 + [res_genes]*3 
...
# Save matrix
np.save("ciao_matrix_avg.npy", ciao_avg)
print("✅ Saved final matrix as 'ciao_matrix_avg.npy'")

# Plot
red_blue_cmap = LinearSegmentedColormap.from_list("BlueRed", ["blue", "red"])
plt.figure(figsize=(10, 8))
plt.imshow(
    ciao_avg.T, # Transpose to match the plot
    cmap=red_blue_cmap,
    origin='lower',
    extent=[1, 200, 1, 200],
    aspect='auto',
...
plt.tight_layout()
plt.savefig("ciao_matrix_avg_plot.png")
plt.show()
print(" Saved plot as 'ciao_matrix_avg_plot.png'")
